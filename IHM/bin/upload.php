...
class qqFileUploader {
    ...
    private function checkServerSettings(){        
        $postSize = $this->toBytes(ini_get('post_max_size')) / 1024 / 1024;
        $uploadSize = $this->toBytes(ini_get('upload_max_filesize')) / 1024 / 1024 ;        
        
//		die("{'errorr:'".$postSize." and ".$uploadSize." and ".($this->sizeLimit/ 1024 / 1024)."'}");
