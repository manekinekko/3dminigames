 ...
 * @return: Un tableau contenant des tableaux à 2 éléments des colladas en collision.
 */
	M3D.MOTEUR.setPosition = function(id,tabPos,testCollision,idRef){
 ...
 * @return: Un tableau contenant des tableaux à 2 éléments des colladas en collision.
 */
	M3D.MOTEUR.rotate = function(id,tabRot,testCollision,idRef){
 ...
 * @return: Un tableau contenant des tableaux à 2 éléments des colladas en collision.
 */
	M3D.MOTEUR.setAngle = function(id,tabRot,testCollision,idRef){
		var matRot = new GLGE.rotateMatrix(tabRot);
		if(idRef == undefined){	
			var modelRef = GLGE.identMatrix();
			var absRot = matRot;
 ...
 * @return: Un tableau contenant des tableaux à 2 éléments des colladas en collision.
 */
	M3D.MOTEUR.mulScale = function (id,coefScale,testCollision){
		var object = M3D.MOTEUR.getObjectOrCamera(id);
		var currentModelMatrix = object.getModelMatrix();
 ...
 * @return: Un tableau contenant des tableaux à 2 éléments des colladas en collision.
 */
	M3D.MOTEUR.setScale = function (id,coefScale,testCollision){
		var object = M3D.MOTEUR.getObjectOrCamera(id);
