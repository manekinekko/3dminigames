\note{J'ai besoin ici de la liste des mots-clés (éventuellement plusieurs type de mots-clés) (séparés par des virgules ca serait encore plus cool pour 
ma feignasserie) pour générer une jolie typo différente selon les types de mots-clés}
...
musiqueAngoissante is media loop.       //'loop' pour jouer en boucle et 'once' pour une seule fois lorsqu'elle est appel\'ee
musiqueVictoire is media once.
musiqueDefaite is media once.


definition generer10Zombies means
	generate 9 zombie on sol,    //10 nouveaux zombies sont g\'en\'er\'es
	generate 1 zombie in zone     //1 zombie en plus est g\'en\'er\'e \`a l'int\'erieur de la zone que le joueur est en train de toucher
...
command key enter for generer10Zombies    //si le joueur veut corser la difficult\'e
...
rule sheriff touches arrivee
	then if score of game = 100             //10 pi\`eces g\'en\'er\'ees qui ont une valeur \`a 10
