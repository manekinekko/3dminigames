...
Huit exemples de jeux en 2D sont décrits par la suite.
Ils ont été codé en JavaScript afin de voir les problèmes inhérents à leur création.
Cela permet également d'appuyer l'analyse du contenu d'un mini-jeu, et d'identifier plus concrètement leurs points communs et leurs singularités.
Ces jeux n'ont pas été choisis par hasard. Chacun possède un intérêt, que ce soir dans la description de ses règles ou dans la façon de l'implémenter. 
...
\titlegame{Billard}
\begin{minipage}{9cm}
Ce mini-jeu de billard est un jeu multijoueur en tour par tour. 
...
D’un point de vue gameplay, le joueur actif (désigné par une icône verte) contrôle la queue de billard avec la souris. Cette dernière pointe automatiquement vers la boule blanche. 
...
Dans le second tableau, PNJ signifie Personne Non Joueur.
