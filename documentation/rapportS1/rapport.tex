...
De l'autre, certains comportements complexes peuveut être précisés.
...
Le compilateur s'adapterait alors en fonction du type de jeu à l'une ou l'autre des types de grammaires.
