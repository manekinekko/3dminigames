...
public class hightLexer extends Lexer {
    ...
    public final void mIDENT() throws RecognitionException {
        try {
            int _type = IDENT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // C:\\Users\\Quentin\\Documents\\M1\\Projet\\svn\\compilation\\hight\\grammars\\hight.g:625:7: ( LETTER ( LETTER | '0' .. '9' | '_' | '-' | '@' )* )
            // C:\\Users\\Quentin\\Documents\\M1\\Projet\\svn\\compilation\\hight\\grammars\\hight.g:625:9: LETTER ( LETTER | '0' .. '9' | '_' | '-' | '@' )*
            {
            mLETTER(); 
            // C:\\Users\\Quentin\\Documents\\M1\\Projet\\svn\\compilation\\hight\\grammars\\hight.g:625:15: ( LETTER | '0' .. '9' | '_' | '-' | '@' )*
            loop6:
            do {
                int alt6=2;
